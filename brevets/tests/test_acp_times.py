...
def test_brevet2():
    ...
    checkpoints = {
                    ...
                    300: (start_time.shift(hours=9, minutes=1), start_time.shift(hours=20)), # CHECK THIS CASE WITH ALI
                    }
...
def test_brevet4():
    ...
    checkpoints = {
                    ...
                    150: (start_time.shift(hours=4, minutes=25), start_time.shift(hours=10)),
                    300: (start_time.shift(hours=9), start_time.shift(hours=20)),
                    450: (start_time.shift(hours=13, minutes=48), start_time.shift(hours=6)),
...
def test_brevet5():
    start_time = arrow.get("2022-02-22 02:22", "YYYY-MM-DD HH:mm")
    dist = 1000
    checkpoints = {
                    0: (start_time, start_time.shift(hours=1)),
                    200: (start_time.shift(hours=5, minutes=53), start_time.shift(hours=13, minutes=20)),
                    ...
                    600: (start_time.shift(hours=18, minutes=48), start_time.shift(hours=16)),
                    800: (start_time.shift(hours=25, minutes=63), start_time.shift(hours=9, minutes=30)),
